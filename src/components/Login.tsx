...
const Login = () => {
  ...
  return (
    ...
    <div className="flex justify-center h-screen">
        <div className="hidden bg-cover lg:block lg:w-2/3 bg-[url(https://ceibal.edu.uy/wp-content/uploads/2023/03/pdasilveira.jpg)]">
            <div className="flex items-center h-full px-20 bg-gray-900 bg-opacity-40">
                <div className=" p-5 backdrop-blur-sm rounded-md shadow-xl">
        ...
        <div className="flex items-center w-full max-w-md px-6 mx-auto lg:w-2/6">
            <div className="flex-1">
                <div className="text-center">
                    ...
                    <p className="mt-3 text-3xl font-semibold text-blue-700 dark:text-gray-300">Inicia sesion </p>
                </div>
                ...
                <div className="mt-8">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mt-6">
                            <div className="flex justify-between mb-2">
                                ...
                                <a href="#" className="text-sm text-gray-500 focus:text-blue-500 hover:text-blue-500 hover:underline">Olvidaste tu contraseña?</a>
                            </div>
                    ...
                    <p className="mt-6 text-sm text-center text-gray-500">No tienes cuenta aun? <a href="#" className="text-blue-500 focus:outline-none focus:underline hover:underline">Registrate</a>.</p>
                </div>
            </div>
        </div>
    </div>
