...
<section className="bg-slate-900">
    <div className="container flex items-center justify-center min-h-screen px-6 mx-auto">
        ...
        <form onSubmit={handleSubmit} className="w-full max-w-md">
         ...
         {
    message && (
<div className="flex w-full max-w-sm overflow-hidden absolute top-10 animate-bounce ml-10  bg-white rounded-lg shadow-md dark:bg-gray-800">
    ...
    <div className="px-4 py-2 -mx-3">
        <div className="mx-3">
            ...
            <div className="relative flex items-center mt-4">
                ...
                <input type="password" className="block w-full px-10 py-3 text-gray-700 bg-white border rounded-lg dark:bg-gray-900 dark:text-gray-300 dark:border-gray-600 focus:border-blue-400 dark:focus:border-blue-300 focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="******"/>
            </div>
            ...
            <div className="mt-6">
                ...
                <a href="#" className="flex items-center justify-center px-6 py-3 mt-4 bg-white hover:bg-gray-300 text-gray-600 transition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text-gray-200  dark:hover:bg-gray-600">
                    ...
                    <span className="mx-2 ">Ingresa con Google</span>
                </a>

                <div className="mt-6 text-center ">
                    <Link to='/register' className="text-2xl text-blue-500 hover:underline dark:text-blue-400">
